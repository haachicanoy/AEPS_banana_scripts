...
dataSet <- read.csv('banasan_cosechas_suelo_foliar_clima_corrected.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
...
dataSet <- dataSet[,c("fechaCosecha",                                                                                      # Date ID; "Year","Week",
                      ...
                      "TX_avg_DIFF","TM_avg_DIFF","T_avg_DIFF","Diurnal_Range_avg_DIFF","TX_freq_34_DIFF",
                      "TM_freq_20_DIFF","P_accu_DIFF","P_10_freq_DIFF","P_inf7_freq_DIFF","RH_avg_DIFF","SR_accu_DIFF",
                      "TX_avg_FLOW","TM_avg_FLOW","T_avg_FLOW","Diurnal_Range_avg_FLOW","TX_freq_34_FLOW",
                      "TM_freq_20_FLOW","P_accu_FLOW","P_10_freq_FLOW","P_inf7_freq_FLOW","RH_avg_FLOW","SR_accu_FLOW",
                      "TX_avg_DEVL","TM_avg_DEVL","T_avg_DEVL","Diurnal_Range_avg_DEVL","TX_freq_34_DEVL",
                      "TM_freq_20_DEVL","P_accu_DEVL","P_10_freq_DEVL","P_inf7_freq_DEVL","RH_avg_DEVL","SR_accu_DEVL",
