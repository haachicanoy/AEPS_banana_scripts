...
dataSet <- read.csv('./_samaria/samaria_cosechas_finca_clima.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
dataSet <- dataSet[,c(20:ncol(dataSet), 9)]
