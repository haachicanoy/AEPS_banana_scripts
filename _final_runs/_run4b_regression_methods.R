...
dataSet <- read.csv('./_cobana/cobana_siembras_clima_cycle.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
dataSet <- dataSet[,c(2:5, 10:ncol(dataSet), 6)]
...
inputs  <- 1:15  # inputs columns
segme   <- 16    # split column; In case of exists variety variable USE IT HERE
output  <- 17    # output column
