...
dataSet <- read.csv('./all_merma_clima.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
...
runID <- paste(wkDir, '/_runMerma_clima', sep='')
