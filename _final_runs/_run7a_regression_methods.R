...
dataSet <- read.csv('./_samaria/samaria_cosechas_lote_clima.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
dataSet <- dataSet[,c(31, 34:66, 14)]
