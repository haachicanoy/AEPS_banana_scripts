...
dataSet <- read.csv('./_cobana/cobana_siembras_clima.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
dataSet <- dataSet[,c(2:5, 11:ncol(dataSet), 6)]
...
inputs  <- 1:37  # inputs columns
segme   <- 38    # split column; In case of exists variety variable USE IT HERE
