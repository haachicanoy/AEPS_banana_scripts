...
dataSet <- read.csv('./_samaria/samaria_cosechas_lote_clima_cycle.csv') # Change according database to analyse. It could be included climate, soils, foliar, etc. information
dataSet <- dataSet[,c(31, 34:43, 14)]
...
segme   <- 11    # split column; In case of exists variety variable USE IT HERE
